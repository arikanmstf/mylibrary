...
class PublicationDetailsPage extends Component {
	...
	setWriters() {
		let writers = this.props.publication.writers;
		console.log(this.props.publication.writers)
